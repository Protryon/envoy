...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    proxy_wasm_cpp_host = dict(
        ...
        project_url = "https://github.com/protryon/proxy-wasm-cpp-host",
        version = "2485772a823570fadcb5d35ff2791c9c933e21fc",
        sha256 = "7e6d3f63ecdebf9f5f934d9bea8ed177b584cf2d5428f45329afd3bf44c5329a",
        strip_prefix = "proxy-wasm-cpp-host-{version}",
        urls = ["https://github.com/protryon/proxy-wasm-cpp-host/archive/{version}.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
            "envoy.access_loggers.wasm",
            "envoy.bootstrap.wasm",
